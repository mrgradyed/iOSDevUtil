...
@implementation SharedAudioController
...
- (AVAudioPlayer *)iiiiPlayer
{
    ...
    if (!_iiiiPlayer)
    {
        _iiiiPlayer = [SharedAudioController audioPlayerFromResource:@"iiii"
                                                                      ofType:@"caf"
                                                                withDelegate:nil
                                                                      volume:0.4f
                                                            andNumberOfLoops:0];
...
- (AVAudioPlayer *)uiiiPlayer
{
    ...
    if (!_uiiiPlayer)
    {
        _uiiiPlayer = [SharedAudioController audioPlayerFromResource:@"uiii"
                                                                      ofType:@"caf"
                                                                withDelegate:nil
                                                                      volume:0.4f
                                                            andNumberOfLoops:0];
...
- (AVAudioPlayer *)uuuePlayer
{
    ...
    if (!_uuuePlayer)
    {
        _uuuePlayer = [SharedAudioController audioPlayerFromResource:@"uuue"
                                                                      ofType:@"caf"
                                                                withDelegate:nil
                                                                      volume:0.4f
                                                            andNumberOfLoops:0];
...
- (AVAudioPlayer *)popPlayer
{
    ...
    if (!_popPlayer)
    {
        _popPlayer = [SharedAudioController audioPlayerFromResource:@"pop"
                                                                     ofType:@"caf"
                                                               withDelegate:nil
                                                                     volume:0.4f
                                                           andNumberOfLoops:0];
...
- (void)setMusicOff:(BOOL)musicOff
{
    ...
    else
    {
        ...
        _musicPlayer =
            [SharedAudioController audioPlayerFromResource:self.currentMusicFileName
...
- (void)playIiiiSound
{
    ...
    dispatch_async([SharedAudioController sharedSoundEffectsSerialQueue], ^(void) {
                   ...
                   withVolume:(float)volume
{
    ...
    dispatch_async(globalDefaultQueue, ^(void) {
        ...
        self.musicPlayer = [SharedAudioController audioPlayerFromResource:fileName
                                                                           ofType:fileType
                                                                     withDelegate:self
                                                                           volume:volume
                                                                 andNumberOfLoops:-1];
...
+ (instancetype)sharedAudioController
{
    ...
    static SharedAudioController *sharedAudioController;
