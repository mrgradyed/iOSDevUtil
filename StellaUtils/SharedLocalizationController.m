...
#import "SharedLocalizationController.h"

@interface SharedLocalizationController ()
...
@implementation SharedLocalizationController
...
- (NSString *)nextSupportedLanguage
{
    ...
    NSInteger currentLanguageIndex =
        [[SharedLocalizationController supportedLanguagesCodes] indexOfObject:self.currentLanguageCode];
    ...
    NSInteger nextLanguageIndex =
        (currentLanguageIndex + 1) % [[SharedLocalizationController supportedLanguagesCodes] count];

    // Returns the code of the next language.

    return [SharedLocalizationController supportedLanguagesCodes][nextLanguageIndex];
}
...
+ (instancetype)sharedLocalizationController
{
    ...
    static SharedLocalizationController *sharedLocalizationController;
...
- (instancetype)initActually
{
    ...
    if (self)
    {
        ...
        NSArray *supportedLanguagesCodes = [SharedLocalizationController supportedLanguagesCodes];
